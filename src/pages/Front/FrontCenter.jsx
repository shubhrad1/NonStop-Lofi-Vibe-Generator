  ...
  return (
    <div className="bg-black p-6">
      <div className="text-white text-center">
        ...
        <div style={{ position: "relative", width: "50%", margin: "0 auto", marginTop: "50px"}}>
          <video controls autoPlay={false} loop={false} style={{ width: "100%", borderRadius: "10px", boxShadow: "0 4px 8px rgba(0, 0, 0, 0.3)" }}>
